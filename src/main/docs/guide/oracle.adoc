...
You must also configure `micronaut.cache.oracle.datasource` with the datasource name that will host the Oracle cache schema and runtime operations, and `micronaut.cache.oracle.prefix` with the prefix you want to assign to your SQL cache objects.
