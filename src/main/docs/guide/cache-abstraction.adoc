...
This example is a cache with the removal/eviction listeners. To be able to use them just implement the RemovalListener interface as shown in the example.
